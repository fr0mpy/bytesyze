...
**All user-facing text MUST use translation keys from `@bytesyze/i18n`.**
...
import { getTranslations, metadata } from '@bytesyze/i18n'
...
import {
  ...
  metadata,                  // Layout keys
  aria, labels, placeholder, srOnly,  // Common keys
  navigation, brand, settings,       // Shared keys
  mobileWarning, error,      // UI keys
} from '@bytesyze/i18n'
```
